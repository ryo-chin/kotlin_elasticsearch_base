...
import jooq.information_schema.tables.records.RoutinesRecord;
...
public class Routines extends TableImpl<RoutinesRecord> {
    ...
    private static final long serialVersionUID = -1632585262;
     ...
     */
    public final TableField<RoutinesRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR(77).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
