...
public class Triggers extends TableImpl<TriggersRecord> {
    ...
    private static final long serialVersionUID = -275970355;
     ...
     */
    public final TableField<TriggersRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR(77).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
