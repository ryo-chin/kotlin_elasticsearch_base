...
public class Views extends TableImpl<ViewsRecord> {
    ...
    private static final long serialVersionUID = -121136819;
     ...
     */
    public final TableField<ViewsRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR(77).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
