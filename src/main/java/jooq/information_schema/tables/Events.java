...
import jooq.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
    ...
    private static final long serialVersionUID = -1907766215;
     ...
     */
    public final TableField<EventsRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR(77).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
